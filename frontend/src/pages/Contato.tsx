            ...
            <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">contato@firenze.com.br</p>
                      <p className="text-gray-600">atendimento@firenze.com.br</p>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="flex space-x-3">
                  ...
                  <a href="#" className="w-10 h-10 bg-blue-800 rounded-full flex items-center justify-center text-white">
